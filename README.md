...
<a href="#1-qf-lca-quantum-hardware-synthesis-engine-and-phase-simulator" target="_blank"><img src="./assets/QFLCH_Poster.png" alt="QF-LC Hardware Synthesis Engine (Hypercube)" style="width: 100vw !important; max-width: none !important; border-radius: 8px; border: 2px solid #8b5cf6; position: relative; left: 50%; transform: translateX(-50%);"></a><br> 
